                ...
                <div className={"flex flex-col justify-center items-center max-w-xs max-h-90 bg-white rounded-lg shadow-md"}>
                    ...
                    <div className="px-3 pb-3">
                        ...
                        <div className="flex justify-around items-center">
                            <span className="mr-1 text-xl font-bold text-gray-900">$10.000</span>
                            <a href="#" className="ml-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-1.5 text-center" 
                                onClick={() => {
                                setOpenModal(true)}}>Comprar</a>
                        </div>
